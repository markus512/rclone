...
You can also find a [mirror of the downloads on github](https://github.com/markus512/rclone/releases/tag/{{< version >}}).
...
log](https://github.com/markus512/rclone/commits/master).  The most recent
